        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/" className="text-foreground/70 hover:text-accent transition-colors no-underline">
                  {t('garden')}
                </Link>
              </li>
              <li>
                <Link href="/series" className="text-foreground/70 hover:text-accent transition-colors no-underline">
                  {t('series')}
                </Link>
              </li>
              <li>
                <Link href="/archive" className="text-foreground/70 hover:text-accent transition-colors no-underline">
                  {t('archive')}
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-foreground/70 hover:text-accent transition-colors no-underline">
                  {t('about')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {siteConfig.social.github && (
                <li>
                  <a href={siteConfig.social.github} target="_blank" rel="noopener noreferrer" className="text-foreground/70 hover:text-accent transition-colors no-underline flex items-center gap-2">
                    GitHub
                  </a>
                </li>
              )}
              {siteConfig.social.twitter && (
                <li>
                  <a href={siteConfig.social.twitter} target="_blank" rel="noopener noreferrer" className="text-foreground/70 hover:text-accent transition-colors no-underline flex items-center gap-2">
                    Twitter
                  </a>
                </li>
              )}
              <li>
                <a href="/feed.xml" className="text-foreground/70 hover:text-accent transition-colors no-underline flex items-center gap-2">
                  RSS Feed
                </a>
              </li>
            </ul>
